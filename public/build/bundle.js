...
var app = (function () {
    ...
    function create_else_block(ctx) {
    	...
    	function atextbox_value_binding(value) {
    		/*atextbox_value_binding*/ ctx[9](value);
    	}
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(div0, file$1, 54, 2, 1084);
    			attr_dev(div1, "class", "card card__back svelte-1sget3a");
    			add_location(div1, file$1, 51, 0, 1010);
    		},
    		m: function mount(target, anchor) {
    			...
    			if (!mounted) {
    				dispose = listen_dev(div1, "click", /*click_handler_1*/ ctx[10], false, false, false);
    				mounted = true;
    			}
    		},
    		p: function update(ctx, dirty) {
    			const atextbox_changes = {};
    			if (dirty & /*editable*/ 8) atextbox_changes.disabled = !/*editable*/ ctx[3];
    ...
    function create_if_block(ctx) {
    	...
    	function atextbox0_value_binding(value) {
    		/*atextbox0_value_binding*/ ctx[6](value);
    	}
    	...
    	function atextbox1_value_binding(value) {
    		/*atextbox1_value_binding*/ ctx[7](value);
    	}
    	...
    	const block = {
    		c: function create() {
    			...
    			attr_dev(div0, "class", "card__content svelte-1sget3a");
    			add_location(div0, file$1, 36, 2, 743);
    			attr_dev(div1, "class", "card__content svelte-1sget3a");
    			add_location(div1, file$1, 43, 2, 878);
    			attr_dev(div2, "class", "card svelte-1sget3a");
    			add_location(div2, file$1, 33, 0, 680);
    		},
    		m: function mount(target, anchor) {
    ...
    function create_each_block(key_1, ctx) {
    	...
    	const block = {
    		...
    		c: function create() {
    			...
    			add_location(button, file$4, 100, 8, 2172);
    			attr_dev(div, "class", "card__wrapper svelte-ogdi1b");
    			add_location(div, file$4, 96, 6, 2044);
    			this.first = div;
    		},
    		m: function mount(target, anchor) {
    ...
    function create_fragment$4(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(h20, file$4, 91, 2, 1849);
    			attr_dev(h21, "class", "title svelte-ogdi1b");
    			add_location(h21, file$4, 93, 2, 1920);
    			attr_dev(div, "class", "card__container svelte-ogdi1b");
    			add_location(div, file$4, 94, 2, 1951);
    			add_location(main, file$4, 89, 0, 1768);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
