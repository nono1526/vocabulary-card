...
var app = (function () {
    ...
    function create_fragment(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(input, file, 42, 0, 866);
    		},
    ...
    function create_else_block(ctx) {
    	...
    	function atextbox_value_binding(value) {
    		/*atextbox_value_binding*/ ctx[7](value);
    	}

    	let atextbox_props = { fontSize: "3rem" };

    	if (/*tw*/ ctx[1] !== void 0) {
    		atextbox_props.value = /*tw*/ ctx[1];
    	}

    	atextbox = new ATextbox({ props: atextbox_props, $$inline: true });
    	binding_callbacks.push(() => bind(atextbox, "value", atextbox_value_binding));

    	const block = {
    		c: function create() {
    			div1 = element("div");
    			div0 = element("div");
    			create_component(atextbox.$$.fragment);
    			attr_dev(div0, "class", "card__content svelte-1sget3a");
    			add_location(div0, file$1, 48, 2, 906);
    			attr_dev(div1, "class", "card card__back svelte-1sget3a");
    			add_location(div1, file$1, 47, 0, 874);
    		},
    		m: function mount(target, anchor) {
    			insert_dev(target, div1, anchor);
    			append_dev(div1, div0);
    			mount_component(atextbox, div0, null);
    			current = true;
    		},
    		p: function update(ctx, dirty) {
    			const atextbox_changes = {};

    			if (dirty & /*$$scope*/ 256) {
    				atextbox_changes.$$scope = { dirty, ctx };
    			}

    			if (!updating_value && dirty & /*tw*/ 2) {
    				updating_value = true;
    				atextbox_changes.value = /*tw*/ ctx[1];
    				add_flush_callback(() => updating_value = false);
    			}

    			atextbox.$set(atextbox_changes);
    		},
    		i: function intro(local) {
    			if (current) return;
    			transition_in(atextbox.$$.fragment, local);
    			current = true;
    		},
    		o: function outro(local) {
    			transition_out(atextbox.$$.fragment, local);
    			current = false;
    		},
    		d: function destroy(detaching) {
    			if (detaching) detach_dev(div1);
    			destroy_component(atextbox);
    		}
    	};
    ...
    function create_if_block(ctx) {
    	...
    	function atextbox0_value_binding(value) {
    		/*atextbox0_value_binding*/ ctx[5](value);
    	}

    	let atextbox0_props = {
    		fontSize: "3rem",
    		disabled: !/*editable*/ ctx[3]
    	};
    	...
    	function atextbox1_value_binding(value) {
    		/*atextbox1_value_binding*/ ctx[6](value);
    	}

    	let atextbox1_props = { disabled: !/*editable*/ ctx[3] };
    	...
    	const block = {
    		c: function create() {
    			...
    			attr_dev(div0, "class", "card__content svelte-1sget3a");
    			add_location(div0, file$1, 32, 2, 607);
    			attr_dev(div1, "class", "card__content svelte-1sget3a");
    			add_location(div1, file$1, 39, 2, 742);
    			attr_dev(div2, "class", "card svelte-1sget3a");
    			add_location(div2, file$1, 31, 0, 586);
    		},
    		m: function mount(target, anchor) {
    		...
    		p: function update(ctx, dirty) {
    			...
    			if (dirty & /*editable*/ 8) atextbox0_changes.disabled = !/*editable*/ ctx[3];
    			...
    			if (dirty & /*editable*/ 8) atextbox1_changes.disabled = !/*editable*/ ctx[3];
    ...
    function instance$1($$self, $$props, $$invalidate) {
    	...
    	const writable_props = ["editable", "en", "tw", "partOfSpeech", "isFront"];
    	...
    	$$self.$$set = $$props => {
    		...
    		if ("isFront" in $$props) $$invalidate(4, isFront = $$props.isFront);
    	};
    ...
    // (46:4) <AButton       dark       on:click={(e) => dispatcher('add-card', {         en,         tw,         partOfSpeech       })}     >
    function create_default_slot_1(ctx) {
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "slot",
    		source: "(46:4) <AButton       dark       on:click={(e) => dispatcher('add-card', {         en,         tw,         partOfSpeech       })}     >",
    		ctx
    	});
    ...
    // (56:4) <AButton dark on:click="{e => isFront = !isFront}">
    function create_default_slot(ctx) {
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "slot",
    		source: "(56:4) <AButton dark on:click=\\\"{e => isFront = !isFront}\\\">",
    		ctx
    	});
    ...
    function create_fragment$3(ctx) {
    	...
    	function card_partOfSpeech_binding(value) {
    		/*card_partOfSpeech_binding*/ ctx[5](value);
    	}

    	function card_en_binding(value) {
    		/*card_en_binding*/ ctx[6](value);
    	}

    	function card_tw_binding(value) {
    		/*card_tw_binding*/ ctx[7](value);
    	}
    	...
    	abutton0.$on("click", /*click_handler*/ ctx[8]);
    	...
    	abutton1.$on("click", /*click_handler_1*/ ctx[9]);
    ...
    function instance$3($$self, $$props, $$invalidate) {
    	...
    	const click_handler = e => dispatcher("add-card", { en, tw, partOfSpeech });
    ...
    function create_each_block(key_1, ctx) {
    	...
    	let mounted;
    	let dispose;
    	const card_spread_levels = [/*vocabulary*/ ctx[8]];
    	let card_props = {};
    	...
    	const block = {
    		...
    		c: function create() {
    			...
    			add_location(button, file$4, 84, 8, 1802);
    			attr_dev(div, "class", "card__wrapper svelte-ogdi1b");
    			add_location(div, file$4, 82, 6, 1728);
    			this.first = div;
    		},
    		m: function mount(target, anchor) {
    		...
    		p: function update(new_ctx, dirty) {
    			...
    			? get_spread_update(card_spread_levels, [get_spread_object(/*vocabulary*/ ctx[8])])
    			: {};
    ...
    function create_fragment$4(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(h20, file$4, 77, 2, 1533);
    			attr_dev(h21, "class", "title svelte-ogdi1b");
    			add_location(h21, file$4, 79, 2, 1604);
    			attr_dev(div, "class", "card__container svelte-ogdi1b");
    			add_location(div, file$4, 80, 2, 1635);
    			add_location(main, file$4, 75, 0, 1452);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
