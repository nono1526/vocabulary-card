...
var app = (function () {
    ...
    // (23:2) {#each vocabularies as vocabulary }
    function create_each_block(ctx) {
    	let card;
    	let current;
    	const card_spread_levels = [/*vocabulary*/ ctx[2]];
    	...
    	const block = {
    		...
    		p: function update(ctx, dirty) {
    			...
    			? get_spread_update(card_spread_levels, [get_spread_object(/*vocabulary*/ ctx[2])])
    			: {};
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "each",
    		source: "(23:2) {#each vocabularies as vocabulary }",
    		ctx
    	});
    ...
    function create_fragment$4(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(main, file$4, 20, 0, 376);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    ...
    function instance$4($$self, $$props, $$invalidate) {
    	...
    	$$self.$capture_state = () => ({ Card, CardMaker, vocabularies, addCard });
