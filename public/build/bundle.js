...
var app = (function () {
    ...
    // (30:4) <AButton       dark       on:click={(e) => dispatcher('add-card', {         en,         tw       })}     >
    function create_default_slot(ctx) {
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "slot",
    		source: "(30:4) <AButton       dark       on:click={(e) => dispatcher('add-card', {         en,         tw       })}     >",
    		ctx
    	});
    ...
    function create_fragment$3(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			attr_dev(div0, "class", "my-1 card-maker__add-btn svelte-12ijpri");
    			add_location(div0, file$3, 28, 2, 529);
    			attr_dev(div1, "class", "card-maker svelte-12ijpri");
    			add_location(div1, file$3, 26, 0, 444);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
