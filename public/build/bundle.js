...
var app = (function () {
    ...
    function create_else_block(ctx) {
    	...
    	function atextbox_value_binding(value) {
    		/*atextbox_value_binding*/ ctx[10](value);
    	}
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(div0, file$2, 58, 2, 1157);
    			attr_dev(div1, "class", "card__content svelte-1sget3a");
    			add_location(div1, file$2, 66, 2, 1305);
    			attr_dev(div2, "class", "card card__back svelte-1sget3a");
    			add_location(div2, file$2, 55, 0, 1083);
    		},
    		m: function mount(target, anchor) {
    			...
    			mount_component(atextarea, div1, null);
    			current = true;

    			if (!mounted) {
    				dispose = listen_dev(div2, "click", /*click_handler_1*/ ctx[12], false, false, false);
    				mounted = true;
    			}
    		},
    		p: function update(ctx, dirty) {
    			const atextbox_changes = {};
    			if (dirty & /*editable*/ 16) atextbox_changes.disabled = !/*editable*/ ctx[4];
    			...
    			if (!updating_value_1 && dirty & /*example*/ 8) {
    ...
    function create_if_block(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			attr_dev(div0, "class", "card__content svelte-1sget3a");
    			add_location(div0, file$2, 40, 2, 816);
    			attr_dev(div1, "class", "card__content svelte-1sget3a");
    			add_location(div1, file$2, 47, 2, 951);
    			attr_dev(div2, "class", "card svelte-1sget3a");
    			add_location(div2, file$2, 37, 0, 753);
    		},
    		m: function mount(target, anchor) {
    			insert_dev(target, div2, anchor);
    			append_dev(div2, div0);
