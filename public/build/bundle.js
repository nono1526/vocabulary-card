...
var app = (function () {
    ...
    // (36:2) <AButton on:click={resetCardDBTable}>
    function create_default_slot_1(ctx) {
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "slot",
    		source: "(36:2) <AButton on:click={resetCardDBTable}>",
    		ctx
    	});
    ...
    // (38:2) {#each vocabularies as vocabulary }
    function create_each_block(ctx) {
    	...
    	function click_handler(...args) {
    		return /*click_handler*/ ctx[4](/*vocabulary*/ ctx[8], ...args);
    	}
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(button, file$4, 39, 4, 1013);
    		},
    		m: function mount(target, anchor) {
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "each",
    		source: "(38:2) {#each vocabularies as vocabulary }",
    		ctx
    	});
    ...
    function create_fragment$4(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(main, file$4, 34, 0, 806);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
